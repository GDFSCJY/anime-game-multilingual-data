...
# git submodule init GAMEDATA/StarRailData
callsh('git submodule init GAMEDATA/StarRailData')
# git submodule update --remote GAMEDATA/StarRailData
callsh('git submodule update --remote GAMEDATA/StarRailData')
